...
//			}
	...
	private IndividualReportType createIndividualReportType() throws DatatypeConfigurationException {
		...
		try {
			...
			//create patient data
			PatientDemographicsType patientDemography = new NDRMainDictionary().createPatientDemographicsType(patient, facility, openmrsConn);
    ...
    private ConditionType createHIVCondition() throws DatatypeConfigurationException {
        ...
        try {
            ...
            HIVEncounterType hivEncounter = mainDictionary.createHIVEncounterType(this.patient, this.encounters);
            ...
            ChildFollowupType childFollowupType = mainDictionary.createChildFollowupType(patient, this.encounters,  this.allobs);
            ...
            InfantPCRTestingType infantPCRTestingType = mainDictionary.createInfantPcr(patient, this.encounters, this.allobs);
	...
	private AddressType createPatientAddress() {
		...
		if (pa != null) {
			...
			try {
				...
				e.printStackTrace();
				LoggerUtils.write(NDRMainDictionary.class.getName(), e.getMessage(), LoggerUtils.LogFormat.FATAL, LogLevel.live);
			}
		}
		return p;
	}
