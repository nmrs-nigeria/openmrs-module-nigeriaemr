...
@XmlType(name = "LaboratoryReportType", propOrder = { "visitID", "visitDate", "laboratoryTestIdentifier", "collectionDate",
        "baselineRepeatCode", "artStatusCode", "laboratoryOrderAndResult", "clinician", "reportedBy", "checkedBy" })
