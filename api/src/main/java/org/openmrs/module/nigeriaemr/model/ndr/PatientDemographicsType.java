...
@XmlType(name = "PatientDemographicsType", propOrder = { "patientIdentifier", "treatmentFacility",
        ...
        "patientMaritalStatusCode", "stateOfNigeriaOriginCode", "patientNotes", "fingerPrints", "familyName", "firstName",
        "otherName", "phoneNumber", "enrolleeCode" })
public class PatientDemographicsType {
	...
	protected FingerPrintsType fingerPrints;
	...
	@XmlElement(name = "EnrolleeCode")
	protected String enrolleeCode;
	...
	public FingerPrintsType getFingerPrints() {
		return fingerPrints;
	}
	
	public void setFingerPrints(FingerPrintsType fingerPrints) {
